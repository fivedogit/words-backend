...
@DynamoDBTable(tableName="words_dislikes") // specifically, *comment* dislikes
public class DislikeItem implements java.lang.Comparable<DislikeItem> {
	...
	@DynamoDBIgnore
	public int compareTo(DislikeItem o) // this makes more recent comments come first
	{
	    Long othertimestamp = ((DislikeItem)o).getMSFE();
